---
name: opencli-cli
description: "OpenCLI command reference — 60+ website and desktop app adapters. Use when the user wants to fetch data from websites (Twitter, GitHub, HN, etc.), interact with desktop apps, or manage opencli commands."
